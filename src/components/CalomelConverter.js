...
const CalomelConverter = () => {
  ...
  const referenceDefaults = {
    ...
    AgAgCl: 0.042,
    HgO: 0.143,
    RHE: 0.241, // O valor do RHE será ajustado no cálculo
  };
  ...
  const handleConvert = () => {
    ...
    setResults({
      SHE: (calomel + references.SHE).toFixed(3),
      AgAgCl: (calomel + references.AgAgCl).toFixed(3),
      HgO: (calomel - references.HgO).toFixed(3),
  ...
  return (
    <div className="converter-container">
      ...
      <Card className="input-card">
        <CardContent>
          <Typography variant="h6">Convert from Calomel</Typography>
          <TextField
            type="number"
